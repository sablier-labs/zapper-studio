...
export const sablierV2LockupLinearV20Abi = [
  {
    inputs: [
      {
...
export type SablierV2LockupLinearV20 = typeof sablierV2LockupLinearV20Abi;
export type SablierV2LockupLinearV20Contract = GetContractReturnType<SablierV2LockupLinearV20, PublicClient>;

export class SablierV2LockupLinearV20__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: sablierV2LockupLinearV20Abi, publicClient: client });
  }
}
