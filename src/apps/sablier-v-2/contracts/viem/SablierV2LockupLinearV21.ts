...
export const sablierV2LockupLinearV21Abi = [
  {
    inputs: [
      {
...
export type SablierV2LockupLinearV21 = typeof sablierV2LockupLinearV21Abi;
export type SablierV2LockupLinearV21Contract = GetContractReturnType<SablierV2LockupLinearV21, PublicClient>;

export class SablierV2LockupLinearV21__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: sablierV2LockupLinearV21Abi, publicClient: client });
  }
}
