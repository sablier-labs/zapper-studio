...
export const sablierV2LockupDynamicV20Abi = [
  {
    inputs: [
      {
...
export type SablierV2LockupDynamicV20 = typeof sablierV2LockupDynamicV20Abi;
export type SablierV2LockupDynamicV20Contract = GetContractReturnType<SablierV2LockupDynamicV20, PublicClient>;

export class SablierV2LockupDynamicV20__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: sablierV2LockupDynamicV20Abi, publicClient: client });
  }
}
